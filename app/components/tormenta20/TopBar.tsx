...
const TopBar = ({ onAllCharacters }: TopBarProps) => {
  ...
  return (
    <div className="bg-card border-b border-stroke relative z-[100]">
        ...
        <div className="relative">
          ...
          {isMenuOpen && (
            <>
              ...
              {/* Menu Content */}
              <div className="absolute right-0 top-full mt-1 w-48 bg-card border border-stroke rounded-lg shadow-lg z-50 py-1">
                <button
                  onClick={() => {
