...
export type WizardAction =
  ...
  | { type: 'SET_ORIGIN_ITEM_WEAPON_CHOICES'; payload: Record<number, { id: string; name: string }> }
...
export function wizardReducer(state: WizardState, action: WizardAction): WizardState {
  switch (action.type) {
    ...
    case 'SET_ORIGIN_ITEM_CHOICES':
      return {
        ...state,
        data: { ...state.data, originItemChoices: action.payload },
      }

    case 'SET_ORIGIN_ITEM_WEAPON_CHOICES':
      return {
        ...state,
        data: { ...state.data, originItemWeaponChoices: action.payload },
      }
